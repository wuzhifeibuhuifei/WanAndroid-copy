package com.example.wanandroid_copy.common.adapter
 ...
 * @description
 */
class ArticleAdapter(layoutId: Int, datas: List<Article>?) :
    BaseQuickAdapter<Article, BaseViewHolder>(layoutId, datas) {
    ...
    private fun isCollect(collect: Boolean): Int =
        if (collect) R.drawable.ic_collection else R.drawable.ic_uncollection
